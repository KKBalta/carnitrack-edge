...
# Database (SQLite)
ENV DATABASE_PATH=/app/data/carnitrack.db

# Cloud WebSocket
ENV CLOUD_WS_URL=wss://api.carnitrack.cloud/edge/ws
ENV CLOUD_API_URL=https://api.carnitrack.cloud
...
# 3001 - TCP Server for DP-401 Scales
EXPOSE 3000 3001
